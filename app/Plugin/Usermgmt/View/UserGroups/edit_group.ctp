	...
	<div class="um_box_mid">
		<div class="um_box_mid_content">
			...
			<div class="um_box_mid_content_mid" id="addgroup">
				...
				<div>
					<div class="umstyle3"><?php echo __('Nome Grupo');?><font color='red'>*</font></div>
				...
				<div>
					<div class="umstyle3"><?php echo __('Nome Grupo Alias');?><font color='red'>*</font></div>
				...
				<div>
					<div class="umstyle3"><?php echo __('Permitir Registro');?></div>
					<div class="umstyle4"><?php echo $this->Form->input("allowRegistration" ,array("type"=>"checkbox",'label' => false))?></div>
					<div style="clear:both"></div>
				</div>
				<div>
					<div class="umstyle3"></div>
					<div class="umstyle4"><?php echo $this->Form->Submit(__('Alterar Grupo'));?></div>
					<div style="clear:both"></div>
				</div>
