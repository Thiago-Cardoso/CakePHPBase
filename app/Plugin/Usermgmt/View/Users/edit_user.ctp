	...
	<div class="um_box_mid">
		<div class="um_box_mid_content">
			<div class="um_box_mid_content_top">
				<span class="umstyle1"><?php echo __('Editar Usuario'); ?></span>
			...
			<?php   }   ?>
					...
					<div>
						<div class="umstyle3"><?php echo __('Segundo Nome');?><font color='red'>*</font></div>
					...
					<div>
						...
						<div class="umstyle4"><?php echo $this->Form->Submit(__('Alterar Usuario'));?></div>
						<div style="clear:both"></div>
					</div>
