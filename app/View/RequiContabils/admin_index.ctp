<div class="requiContabils index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('id_requi');?></th>
			<th><?php echo $this->Paginator->sort('form1');?></th>
			<th><?php echo $this->Paginator->sort('form2');?></th>
			<th><?php echo $this->Paginator->sort('form3');?></th>
			<th><?php echo $this->Paginator->sort('form4');?></th>
			<th><?php echo $this->Paginator->sort('form5');?></th>
			<th><?php echo $this->Paginator->sort('form6');?></th>
			<th><?php echo $this->Paginator->sort('ano1');?></th>
			<th><?php echo $this->Paginator->sort('ano2');?></th>
	...
	<tr>
		...
		<td><?php echo h($requiContabil['RequiContabil']['id_requi']); ?>&nbsp;</td>
